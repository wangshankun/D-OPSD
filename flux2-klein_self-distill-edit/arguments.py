...
def parse_args():
    ...
    parser.add_argument("--use-lori", action=argparse.BooleanOptionalAction, default=True, help="Use LoRI instead of ordinary LoRA when --use-lora > 1.")
    parser.add_argument("--lori-sparsity", type=float, default=0.9, help="Global sparsity ratio for student LoRA B matrices.")
    parser.add_argument("--lori-calibration-steps", type=int, default=100, help="Dense LoRI-B calibration steps before sparse training.")
    parser.add_argument("--lori-mask-path", type=str, default=None, help="Optional path to a precomputed LoRI mask dictionary.")
